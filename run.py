...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', type=str, default='UniSRec', choices=['SASRecText', 'UniSRec'], help='model name')
    ...
    model_name, dataset_name, results = run_single(args.m, args.d, pretrained_file=args.p)